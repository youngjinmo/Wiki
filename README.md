...
- [Devops](https://github.com/youngjinmo/TIL/tree/master/DevOps)
  - [Linux](DevOps/Linux.md)
    - [명령어](DevOps/Linux.md#linux-commands)
      ...
      - [비트(32/64) 확인](DevOps/Linux.md#uname-m)
      ...
      - [wget으로 파일 다운로드](DevOps/Linux.md#wget)
      - [계정 생성하기](DevOps/Linux.md#adduser)
      - [우분투 패스워드 설정하기](DevOps/Linux.md#password)
    ...
    - 패키지 관리툴
      - [apt-get](DevOps/Linux.md#apt-get)
        ...
        - [Java 설치하기](DevOps/Linux.md#install-java)
